...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('graph_rag_test.log'),
...
class GraphRAGTester:
    ...
    def __init__(self):
        ...
        self.expected_result_keys = [
            'answer', 'reasoning_type', 'confidence', 'metadata'
        ]
    ...
    def test_system_initialization(self) -> dict:
        ...
        try:
            ...
            if self.graph_rag.semantic_embedding.model:
                ...
                logger.warning("⚠ Embedding model not loaded (sentence-transformers may not be installed)")
            ...
            if embedding:
                ...
                if embedding_2:
                    ...
                    if similarity is not None:
                        ...
                        logger.info(f"✓ Similarity calculation successful (score: {similarity:.3f})")
                    else:
            ...
            for query_name in simple_queries:
                try:
                    ...
                    if answer_result and 'answer' in answer_result:
                        ...
                        logger.info(f"✓ {query_name}: Generated answer (confidence: {confidence:.2f}, quality: {quality_score:.2f})")
                    ...
                    if is_complex:
                        ...
                        if answer_result:
                            ...
                            if answer_result.get('reasoning_type') == 'multi_step':
                                ...
                                logger.info(f"✓ {query_name}: Multi-step reasoning with {steps} steps")
                        ...
                        logger.info(f"- {query_name} not identified as complex (will use simple processing)")
    ...
    def assess_answer_quality(self, answer_text: str, original_question: str) -> float:
        ...
        relevant_keywords = [
            'dcf', 'valuation', 'financial', 'analysis', 'risk', 'company',
            'revenue', 'profit', 'investment', 'stock', 'price', 'market'
        ]
    ...
    def print_test_summary(self, test_results: dict):
        ...
        print(f"Document Embeddings: {'✓' if embed_results.get('document_embedding_success') else '✗'}")
