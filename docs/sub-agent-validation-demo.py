...
class SubAgentValidator:
    ...
    def generate_agent_metrics(self) -> Dict[str, Dict]:
        ...
        for agent_file in self.agents_dir.glob("*.md"):
            ...
            metrics[agent_name] = {
                ...
                "documentation_completeness": min(
                    100, (expertise_items + command_mentions + principle_count) * 2
                ),
            }
    ...
    def run_validation(self):
        ...
        avg_completeness = sum(m["documentation_completeness"] for m in metrics.values()) / len(
            metrics
        )
        ...
        print(
            f"  Ecosystem Maturity: {'Production Ready' if avg_completeness > 80 else 'Advanced Development'}"
        )
