...
class QualityMetrics:
    ...
    def analyze_file_quality(file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "found", "size": size, "valid": valid, "path": str(file_path)}
...
class QualityReporter:
    ...
    def finalize_build_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.build_summary.update(
                {
                    ...
                    "overall_statistics": {
                        ...
                        "build_status": (
                            ...
                            else "partial" if overall_success_rate >= 0.5 else "failed"
                        ),
                    },
                }
            )
            ...
            logger.info(
                f"Build quality report finalized: {overall_success_rate:.2%} overall success rate"
            )
