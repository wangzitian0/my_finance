...
class DataAccess:
    ...
    def get_build_dir(self, build_timestamp: Optional[str] = None, branch: Optional[str] = None) -> Path:
        """
    ...
    def get_source_dir(self, source: str, stage: str = "stage_00_original", 
    ...
    def get_ticker_dir(self, source: str, ticker: str, stage: str = "stage_00_original",
                      date_partition: Optional[str] = None) -> Path:
        """
    ...
    def list_builds(self, branch: Optional[str] = None) -> List[str]:
        ...
        builds = [
            d.name.replace("build_", "") for d in build_base.iterdir()
