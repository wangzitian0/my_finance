...
class DirectoryManager:
    ...
    def __init__(self, root_path: Optional[Path] = None, backend: StorageBackend = StorageBackend.LOCAL_FS):
    ...
    def get_subdir_path(self, layer: DataLayer, subdir: str, partition: Optional[str] = None) -> Path:
