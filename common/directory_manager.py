...
class DirectoryManager:
    ...
    def list_tickers_in_stage(self, 
                            stage: str, 
                            date_partition: Optional[str] = None) -> List[str]:
        """
    ...
    def migrate_legacy_structure(self, 
                                stage: str, 
                                legacy_path: Path,
                                date_partition: Optional[str] = None) -> Dict[str, int]:
        """
    ...
    def _migrate_ticker_based(self, stage: str, source_path: Path, date_partition: str) -> Dict[str, int]:
    ...
    def _migrate_date_based(self, stage: str, source_path: Path, date_partition: str) -> Dict[str, int]:
    ...
    def _migrate_mixed_structure(self, stage: str, source_path: Path, date_partition: str) -> Dict[str, int]:
    ...
    def validate_structure(self, stage: str, date_partition: Optional[str] = None) -> Dict[str, any]:
        """
        ...
        for ticker_dir in stage_path.iterdir():
            ...
            for file_path in files:
                if not file_path.name.startswith(ticker_dir.name):
                    results['issues'].append(f"File naming issue: {file_path} should start with {ticker_dir.name}")
