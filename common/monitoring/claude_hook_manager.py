...
class ClaudeHookManager:
    ...
    def start_session(self, session_context: Optional[Dict[str, Any]] = None) -> str:
        ...
        self.execution_monitor.start_execution(
            "claude-hook-manager", 
            f"Claude Code session {self.current_session_id}"
        )
    ...
    def _sanitize_content(self, content: Union[str, Dict, List, Any]) -> Union[str, Dict, List, Any]:
    ...
    def capture_tool_invocation(
        ...
        event = ToolInvocationEvent(
            ...
            metadata={
                "capture_requests": self.config["hooks"]["tool_invocation"].get("capture_requests", True),
                "capture_responses": self.config["hooks"]["tool_invocation"].get("capture_responses", True)
            },
            tool_name=tool_name,
    ...
    def capture_ai_response(
        ...
        event = AIResponseEvent(
            ...
            metadata={
                "capture_thinking": self.config["hooks"]["ai_response"].get("capture_thinking", True),
    ...
    def capture_error(
        ...
        event = ErrorEvent(
            ...
            metadata={
                ...
                "capture_recovery": self.config["hooks"]["error_handling"].get("capture_recovery", True),
    ...
    def _is_hook_enabled(self, hook_type: str) -> bool:
        ...
        return (
            ...
            self.config.get("hooks", {}).get(hook_type, {}).get("enabled", True)
        )
    ...
    def get_hook_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "hooks_status": {
                ...
                for hook_type in ["user_prompt_submit", "tool_invocation", "ai_response", "error_handling"]
            },
