...
class Neo4jHealthServer:
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            self._logger.info(f"  http://{self.host}:{self.port}/health/neo4j/detailed - Detailed diagnostics")
...
def create_health_server(environment: str = None, host: str = '0.0.0.0', port: int = 8080) -> Neo4jHealthServer:
    """
