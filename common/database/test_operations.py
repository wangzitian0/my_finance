...
class TestOperations:
    ...
    def create_test_node(self, test_id: Optional[str] = None, test_data: Optional[Dict] = None) -> Optional[str]:
        """
    ...
    def cleanup_test_nodes(self, environment: Optional[str] = None, older_than_hours: int = 24) -> int:
        """
