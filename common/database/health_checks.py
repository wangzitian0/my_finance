...
class HealthChecker:
    ...
    def comprehensive_health_check(self, include_crud: bool = True) -> HealthStatus:
        ...
        if not performance["baseline_met"]:
            warnings.append(
                f"Performance below baseline: {performance['response_time_ms']}ms > {performance['baseline_threshold_ms']}ms"
            )
    ...
    def monitoring_metrics(self) -> Dict[str, Any]:
        ...
        status_values = {"healthy": 1, "degraded": 0.5, "unhealthy": 0}
        ...
        return {
            ...
            "neo4j_connection_success": (
                1 if health_status.test_operations.get("connection") == "success" else 0
            ),
