...
class ExecutionMonitor:
    ...
    def start_execution(self, agent_type: str, task_description: str, command: Optional[str] = None):
    ...
    def get_execution_stats(self, days: int = 7) -> Dict[str, Any]:
        ...
        for log in all_logs:
            ...
            if retry_count > 0:
                stats["retry_patterns"][retry_count] = stats["retry_patterns"].get(retry_count, 0) + 1
...
def log_failure(agent_type: str, task_description: str, error_message: str, execution_time_ms: int = 0):
