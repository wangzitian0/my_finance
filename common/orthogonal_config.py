...
class OrthogonalConfigLoader:
        ...
        if legacy_file:
            ...
            if legacy_path.exists():
                ...
                return DataSource(
                    ...
                    data_types=config.get("filing_types", list(config.get("periods", {}).keys()) if name == "yfinance" else ["10K", "10Q", "8K"])
                )
    ...
    def build_runtime_config(self, stock_list: str, data_sources: List[str], scenario: str) -> Dict[str, Any]:
        """
