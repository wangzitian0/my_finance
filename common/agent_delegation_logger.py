...
from .execution_monitor import get_monitor, ExecutionResult
...
class AgentDelegationLogger:
    ...
    def get_delegation_stats(self, days: int = 7) -> Dict[str, Any]:
        ...
        for delegation in all_delegations:
            ...
            from_agent = delegation["from_agent"]
            stats["busiest_coordinators"][from_agent] = stats["busiest_coordinators"].get(from_agent, 0) + 1
...
def log_delegation_start(from_agent: str, to_agent: str, task_description: str, task_parameters: Optional[Dict[str, Any]] = None) -> str:
    """Start logging an agent delegation."""
