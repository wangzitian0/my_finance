...
class MetadataManager:
    ...
    def add_file_record(self, source: str, ticker: str, filepath: str, 
                       data_type: str, config_info: Dict[str, Any]) -> None:
            ...
            if (file_record.get("data_type") == data_type and 
                ...
                if created_at > cutoff_time:
                    ...
                    if (os.path.exists(filepath) and 
                        self.calculate_file_md5(filepath) == file_record.get("md5_hash", "")):
                        return True
    ...
    def mark_download_failed(self, source: str, ticker: str, data_type: str, 
                           config_info: Dict[str, Any], error_msg: str) -> None:
