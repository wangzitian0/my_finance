...
from common.agents.agent_task_tracker import AgentTaskTracker, AgentTask, get_tracker
from common.monitoring.execution_monitor import ExecutionResult, ErrorCategory, ExecutionLog
    ...
    def test_database_schema_creation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with sqlite3.connect(db_path) as conn:
                ...
                index_names = ["idx_agent_type", "idx_start_time", "idx_execution_result", "idx_error_category"]
...
class TestAgentPerformanceAnalysis:
    ...
    def populated_tracker(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            categories = [ErrorCategory.LOW, ErrorCategory.MEDIUM, ErrorCategory.HIGH, ErrorCategory.CRITICAL]
            ...
            for i in range(20):
                ...
                error_category = categories[i % len(categories)] if result == ExecutionResult.FAILURE else None
