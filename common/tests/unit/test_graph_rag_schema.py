...
class TestETLStageOutput:
    ...
    def test_vector_index_output(self):
        ...
        output = ETLStageOutput.VectorIndexOutput(
            index_size=1000, index_type="FAISS", search_ready=True, output_path="/data/index"
        )
...
class TestSchemaIntegration:
    ...
    def test_complete_graph_schema_workflow(self):
        ...
        dcf = DCFValuationNode(node_id="dcf-001", ticker=stock.ticker, intrinsic_value=185.50)
