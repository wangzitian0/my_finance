...
from common.config_manager import (
    ConfigManager, ConfigType, ConfigSchema,
...
class TestConfigManager:
    ...
    def test_schema_definition(self, config_manager):
        ...
        required_schemas = [
            "directory_structure", "magnificent_7", "nasdaq_100", "fast_2", "vti_3500",
            "sec_edgar_nasdaq100", "stage_00_original_sec_edgar", "stage_00_original_yfinance"
        ]
