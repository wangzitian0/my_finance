    ...
    def _validate_data_file_organization(self):
        ...
        for root, dirs, files in os.walk(self.root_dir):
            ...
            for file in files:
                ...
                if (file_path.suffix in data_extensions and 
                    file != "README.md" and  # README files are documentation
                    "config" not in str(rel_root).lower() and  # Configuration files allowed
                    "template" not in str(rel_root).lower()):  # Template files allowed
...
def main():
    ...
    try:
        ...
        print(f"Checks Passed: {report['checks_summary']['passed']}/{report['checks_summary']['total']}")
        ...
        print(f"- Unauthorized files removed: {report['cleanup_effectiveness']['unauthorized_files_removed']}")
        print(f"- Empty directories cleaned: {report['cleanup_effectiveness']['empty_directories_cleaned']}")
