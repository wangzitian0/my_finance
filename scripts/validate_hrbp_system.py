...
class HRBPSystemValidator:
    ...
    def validate_p3_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if missing_commands:
                ...
                results['details'].append(f"All {len(required_hrbp_commands)} HRBP commands found in p3.py")
    ...
    def validate_hrbp_components(self) -> Dict[str, Any]:
        ...
        # Core HRBP components to validate
        hrbp_components = [
    ...
    def validate_integration_framework(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'directory_manager' in framework_content:
                results['details'].append('Framework integrates with DirectoryManager (SSOT compliant)')
            else:
    ...
    def generate_report(self, output_file: Optional[Path] = None) -> str:
        ...
        report = {
            'hrbp_system_validation_report': {
                ...
                'test_results': {k: v for k, v in self.validation_results.items() if not k.startswith('_')},
