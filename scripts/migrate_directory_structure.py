...
def migrate_stage_03_load():
    ...
    subdirs = ['dcf_results', 'embeddings', 'graph_embeddings', 'graph_nodes', 'graph_rag_cache', 'vector_index']
...
def validate_migration():
    ...
    print(f"  📂 stage_00_original: {stage_00_results['tickers_found']} tickers, {stage_00_results['files_found']} files")
    ...
    print(f"  📂 stage_03_load: {stage_03_results['tickers_found']} tickers, {stage_03_results['files_found']} files")
    if stage_03_results['issues']:
        for issue in stage_03_results['issues']:
            print(f"    ⚠️  {issue}")
    
    return {
        'stage_00': stage_00_results,
        'stage_03': stage_03_results
    }
...
def main():
    ...
    print(f"  YFinance: {stage_00_stats['yfinance_stats']['files_moved']} files, {stage_00_stats['yfinance_stats']['tickers_processed']} tickers")
    print(f"  SEC Edgar: {stage_00_stats['sec_edgar_stats']['files_moved']} files, {stage_00_stats['sec_edgar_stats']['tickers_processed']} tickers")
    print(f"  Stage 03: {stage_03_stats['files_moved']} files, {stage_03_stats['tickers_processed']} categories")
    
    total_files = (stage_00_stats['yfinance_stats']['files_moved'] + 
