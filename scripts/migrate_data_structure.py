...
class DataMigrator:
    def __init__(self, base_path: str = "/Users/SP14016/zitian/my_finance/data"):
        ...
        self.backup_path = self.base_path / "backup" / datetime.now().strftime("backup_%Y%m%d_%H%M%S")
        ...
        try:
            ...
            for ticker_dir in source_path.iterdir():
                ...
                for file_path in ticker_dir.glob("*.json"):
                    ...
                    if not date_str:
                        logger.warning(f"Could not extract date from {file_path.name}, using today's date")
        ...
        try:
            ...
            for cik_dir in source_path.iterdir():
                ...
                for filing_type_dir in cik_dir.iterdir():
                    ...
                    nested_cik_path = filing_type_dir / cik / filing_type.upper().replace('K', '-K').replace('Q', '-Q')
                    ...
                    for file_path in nested_cik_path.glob("*.txt"):
                        ...
                        new_filename = f"{ticker}_sec_edgar_{filing_type}_{timestamp}_{file_path.name}"
                ...
                with open(readme_path, 'w') as f:
                    ...
                    f.write("Format: `TICKER_sec_edgar_FILING_TYPE_TIMESTAMP_ORIGINAL_FILENAME.txt`\n")
