...
class SemanticRetriever:
    ...
    def rank_by_relevance_and_recency(self, 
                                    chunks: List[RetrievalResult], 
                                    question: str,
                                    recency_weight: float = 0.3,
                                    similarity_weight: float = 0.7) -> List[RetrievalResult]:
        """
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        stop_words = {
            ...
            'should', 'may', 'might', 'must', 'can', 'what', 'when',
            'where', 'why', 'how', 'which', 'who', 'whose'
        }
    ...
    def _get_document_type_boost(self, document_type: str, question: str) -> float:
        ...
        type_relevance = {
            'sec_filing': {
                'keywords': ['financial', 'filing', 'sec', '10-k', '10-q', 'risk', 'revenue', 'earnings'],
                'boost': 0.1
            },
            'news': {
                'keywords': ['news', 'recent', 'latest', 'announcement', 'event', 'impact'],
                'boost': 0.1
            },
            'dcf_valuation': {
                'keywords': ['valuation', 'dcf', 'value', 'worth', 'price', 'intrinsic'],
                'boost': 0.15
            }
        }
        ...
        keyword_matches = sum(1 for keyword in boost_config['keywords'] 
    ...
    def filter_by_date_range(self, 
                           ...
                           end_date: Optional[datetime] = None) -> List[RetrievalResult]:
        """
