...
class StrategyValidator:
    ...
    def _run_dcf_analysis(self) -> Dict:
        ...
        for ticker in self.m7_tickers:
            ...
            try:
                ...
                stock_analysis = {
                    ...
                    "upside_downside_pct": ((180.0 - current_price) / current_price) * 100 if current_price > 0 else 0,
                    "recommendation": "BUY" if current_price < 180.0 * 0.9 else "HOLD" if current_price < 180.0 * 1.1 else "SELL",
        ...
        if successful_analyses:
            avg_upside = sum(r["upside_downside_pct"] for r in successful_analyses) / len(successful_analyses)
            ...
            dcf_results["portfolio_summary"] = {
                ...
                "portfolio_bias": "BULLISH" if avg_upside > 5 else "NEUTRAL" if avg_upside > -5 else "BEARISH"
            }
    ...
    def _run_backtest(self) -> Dict:
        ...
        try:
            ...
            if portfolio_data:
                ...
                sharpe_ratio = (equal_weight_returns.mean() * 252) / volatility if volatility > 0 else 0
    ...
    def _calculate_strategy_score(self, validation_results: Dict) -> float:
        ...
        if benchmark_data.get("relative_performance"):
            outperformed_count = sum(
                1 for perf in benchmark_data["relative_performance"].values()
