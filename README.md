...
- **`ETL/`** - Data processing pipeline: SEC document spiders, semantic embedding, data cleaning
...
- **`common/`** - Common components: module coordination, schema definitions, build tracking
...
- **`spider/`** - Data spiders: SEC Edgar API, YFinance integration
