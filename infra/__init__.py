...
Comprehensive infrastructure management organized by functional domains 
following two-layer modularity architecture per CLAUDE.md.
...
- deployment/    Deployment automation (ansible/, k8s/)
"""