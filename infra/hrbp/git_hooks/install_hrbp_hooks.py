...
Migrated from scripts/install_hrbp_hooks.py as part of infrastructure modularization.
"""
import os
import stat
import subprocess
...
def install_post_merge_hook():
    ...
    try:
        ...
        hrbp_hook_script = project_root / "infra" / "hrbp" / "git_hooks" / "post_merge_hrbp_hook.py"
