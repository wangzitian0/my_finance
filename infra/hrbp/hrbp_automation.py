...
use the new comprehensive CLI: infra/hrbp/hrbp_comprehensive_cli.py

Moved from infra/hrbp_automation.py as part of infrastructure modularization.
"""
import argparse
import json
import sys
...
Examples:
  ...
  python infra/hrbp/hrbp_automation.py record-pr 123
  python infra/hrbp/hrbp_automation.py manual-trigger
  python infra/hrbp/hrbp_automation.py history --limit 5
        """,
    )
...
if __name__ == "__main__":
    ...
    print("   python infra/hrbp/hrbp_comprehensive_cli.py --help")
    print()
    main()
