...
def execute_issue_256_cleanup():
    ...
    expected_core_dirs = {'ETL', 'dcf_engine', 'graph_rag', 'common', 'infra', 'evaluation', 'templates', 'build_data', 'tests'}
    expected_core_files = {'README.md', 'CLAUDE.md', 'pyproject.toml', 'pixi.toml', 'p3', '.gitignore', 'MIGRATION_SUMMARY.md'}
