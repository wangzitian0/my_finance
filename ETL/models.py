...
class Info(StructuredNode):
    ...
    companyOfficers = JSONProperty()  # Stores company officer array information
...
class PriceData(StructuredNode):
    # Historical stock price data, each record corresponds to a date
...
class Sustainability(StructuredNode):
    esgScores = JSONProperty()  # Stores ESG score data
