...
from common.graph_rag_schema import (
    VectorEmbeddingConfig, DocumentChunkNode, SemanticSearchResult,
    DocumentType, DEFAULT_EMBEDDING_CONFIG, ETLStageOutput
)
...
class SemanticEmbeddingGenerator:
    ...
    def generate_document_embeddings(self, data_dir: Path) -> ETLStageOutput.EmbeddingsOutput:
        ...
        try:
            ...
            logger.info(f"Embedding generation completed. Documents processed: {documents_processed}, "
    ...
    def _process_yfinance_documents(self, data_dir: Path, embedding_data: List[Dict]) -> Dict[str, int]:
...
class SemanticRetriever:
    ...
    def retrieve_relevant_content(self, query: str, top_k: int = None, 
                                ...
                                content_filter: Dict[str, Any] = None) -> List[SemanticSearchResult]:
        """
