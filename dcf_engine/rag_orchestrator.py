...
from common.graph_rag_schema import (
    ...
    SemanticSearchResult, DEFAULT_EMBEDDING_CONFIG
)
...
class GraphRAGOrchestrator:
    ...
    def __init__(self, data_dir: Path, neo4j_url: str = "bolt://localhost:7687",
                 neo4j_username: str = "neo4j", neo4j_password: str = "password"):
        """
    ...
    def _setup_neo4j_connection(self):
        ...
        try:
            ...
            db.set_connection(url=self.neo4j_url, 
    ...
    def answer_question(self, question: str) -> GraphRAGResponse:
        ...
        try:
            ...
            logger.debug(f"Query intent: {structured_query.intent}, "
    ...
    def _calculate_confidence_score(self, graph_results: Dict[str, Any], 
                                  semantic_results: List[SemanticSearchResult],
                                  query: GraphRAGQuery) -> float:
        """
        ...
        for result in cypher_results:
            if len(result) >= 4:  # ticker1, ticker2, metrics1, metrics2
                ...
                comparison_data['metrics'].extend([
                    self._extract_metrics(m1),
                    self._extract_metrics(m2)
                ])
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        if self.semantic_retriever:
            ...
            if hasattr(self.semantic_retriever, 'vector_index') and self.semantic_retriever.vector_index:
                status['total_embeddings'] = self.semantic_retriever.vector_index.ntotal
                status['embeddings_loaded'] = True
        
        return status
    
    def test_query(self, test_question: str = "What is the DCF valuation for Apple?") -> Dict[str, Any]:
        """
