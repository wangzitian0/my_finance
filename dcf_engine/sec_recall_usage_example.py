...
class SECRecallUsageExample:
        ...
        queries = [
            {
                ...
                'expected_sources': ['10-K Business section', '10-Q MD&A', 'Earnings call transcripts'],
    ...
    def _simulate_semantic_search(self, ticker: str, queries: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
            ...
            for doc_idx in range(2):  # 2 documents per query
                result = {
                    ...
                    'metadata': {
                        ...
                        'relevance_keywords': self._get_relevance_keywords(query_info['dcf_component'])
                    }
                }
    ...
    def _generate_realistic_content_excerpt(self, ticker: str, dcf_component: str) -> str:
        ...
        return excerpts.get(dcf_component, f"Relevant {ticker} financial information for {dcf_component} analysis.")
    ...
    def _rank_results_by_dcf_relevance(self, search_results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        ranked_results = sorted(search_results, key=lambda x: x['dcf_relevance_score'], reverse=True)
    ...
    def _extract_quantitative_data(self, content: str) -> List[str]:
        ...
        return [q for q in quantitative_examples if any(word in content.lower() for word in q.lower().split())]
    ...
    def _create_cited_dcf_analysis(self, ticker: str, dcf_insights: Dict[str, Any]) -> Dict[str, Any]:
        ...
        cited_analysis['recommendations'] = self._generate_sec_backed_recommendations(ticker, dcf_insights)
    ...
    def _create_executive_summary(self, ticker: str, dcf_insights: Dict[str, Any]) -> str:
        ...
        high_confidence_components = sum(1 for insights in dcf_insights.values() 
...
Confidence level: {insights['confidence_level']}.
        ...
        return component_descriptions.get(component, f"Analysis for {component} based on SEC filing data.").strip()
    ...
    def _assess_overall_confidence(self, dcf_insights: Dict[str, Any]) -> Dict[str, Any]:
        ...
        avg_confidence = sum(confidence_mapping[level] for level in confidence_scores) / len(confidence_scores)
        ...
        return {
            ...
            'recommendation': "Proceed with DCF analysis" if avg_confidence >= 2.0 else "Supplement with additional research"
        }
    
    def _generate_sec_backed_recommendations(self, ticker: str, dcf_insights: Dict[str, Any]) -> Dict[str, Any]:
