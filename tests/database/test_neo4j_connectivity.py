...
class TestNeo4jHealthCheck(unittest.TestCase):
    ...
    def test_comprehensive_health_check_healthy(self):
        ...
        with patch.object(self.health_checker, 'check_basic_connectivity', return_value=mock_connectivity):
            with patch.object(self.health_checker, 'check_performance_baseline', return_value=mock_performance):
                with patch.object(self.health_checker, 'check_database_operations', return_value=mock_crud):
                    with patch.object(self.health_checker, 'get_database_version', return_value='5.15.0'):
