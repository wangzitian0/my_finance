...
class TestP3Workflow:
    ...
    def test_p3_version_command(self):
        ...
        assert "feature/283-module-adjust" in result.stdout, "Should show current branch"
    ...
    def test_p3_script_discovery(self):
        ...
        assert p3_py_path.exists(), "p3.py symlink missing in worktree"
        assert p3_py_path.is_symlink(), "p3.py should be a symlink"

        # Check it points to infra/p3/p3.py
        target = p3_py_path.readlink()
        assert str(target) == "infra/p3/p3.py", f"p3.py points to wrong location: {target}"
    ...
    def test_p3_worktree_isolation(self):
        ...
        assert "feature/283-module-adjust" in result.stdout, "Should show worktree branch"
    ...
    def test_p3_help_commands(self):
        ...
        # p3 treats --help as unknown command but shows available commands
