...
class TestConfigurationSchema(unittest.TestCase):
    ...
    def test_directory_structure_config_exists(self):
        ...
        self.assertTrue(dir_config.exists(), f"Directory structure config should exist at {dir_config}")
...
class TestSubtreeMigrationSuccess(unittest.TestCase):
    ...
    def test_build_data_directory_exists(self):
        ...
        self.assertTrue(build_data_path.exists(), "build_data directory should exist after subtree migration")
    ...
    def test_no_data_submodule(self):
        ...
        if data_path.exists():
            ...
            for item in contents:
                self.assertIn("quality", item.name.lower(), f"data/ should only contain quality reports, found: {item.name}")
        # The key test: build_data should be the main data storage now
        build_data_path = Path(project_root) / "build_data"
        self.assertTrue(build_data_path.exists(), "build_data (subtree) should be the main data storage")
