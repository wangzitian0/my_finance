...
EXCLUDE_DIRS = {
    '.git', '.pixi', '__pycache__', 'node_modules', '.pytest_cache',
    'htmlcov', 'data/stage_00_original', 'data/stage_01_extract', 
    'data/stage_03_load', 'data/stage_99_build', 'data/release',
    'data/test', 'data/quality_reports', 'data/log'
}
