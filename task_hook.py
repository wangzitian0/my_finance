...
Usage:
    from task_hook import hook_task_start, hook_task_end, process_dumps
...
class TaskHook:
    ...
    def end(self, exec_id: str, success: bool, result: str = None, error: str = None, output: str = None):
...
def hook_task_end(exec_id: str, success: bool, result: str = None, error: str = None, output: str = None):
    """End task hook."""
